...
$ python main.py inspect --name fake-comet
...
$ python main.py query --start-date 2020-01-01 --end-date 2029-12-31 --min-diameter 1 --min-distance 0.01 --max-distance 0.1 --outfile results.json
```
...
- 0: Inspect the data. (`data/neos.csv` and `data/cad.json`)
- 1: Build models to represent the data. (`models.py`)
- 2: Extract the data into a custom database (`extract.py` and `database.py`)
...
$ python main.py query --start-date 2020-01-01 --end-date 2020-12-31 --max-distance 0.1

# Query for close approaches in 2020 with a distance of >=0.3 au.
$ python main.py query --start-date 2020-01-01 --end-date 2020-12-31 --min-distance 0.3

# Query for close approaches in 2020 with a velocity of <=50 km/s.
$ python main.py query --start-date 2020-01-01 --end-date 2020-12-31 --max-velocity 50

# Query for close approaches in 2020 with a velocity of >=25 km/s.
$ python main.py query --start-date 2020-01-01 --end-date 2020-12-31 --min-velocity 25

# Query for close approaches of not potentially-hazardous NEOs between 500m and 600m in diameter.
$ python main.py query --min-diameter 0.5 --max-diameter 0.6 --not-hazardous
...
$ python main.py query --max-distance 0.1 --min-velocity 35 --min-diameter 2.5 --hazardous
```
...
$ python main.py query --date 2020-01-01 --limit 5 --outfile results.csv

# Save (the first) five close approaches on 2020-01-01 to a JSON file.
$ python main.py query --date 2020-01-01 --limit 5 --outfile results.json
...
$ python main.py query --start-date 2020-01-01 --end-date 2020-12-31 --hazardous --min-diameter 0.25 --max-distance 0.1 --limit 5 --outfile results.json
```
...
This project requires Python 3.6+. This project has no dependencies external to the Python standard library, so there's no need for virtual environments.
...
OK
$ python -m unittest --verbose tests.test_data_files
